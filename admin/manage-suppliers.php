                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a  href="../admin/updateSuppliers.php?id=<?php echo $row['id']; ?>" class="btn btn-success"><i class="fa fa-fw fa-pencil"></i></a>
                                            <a  href="../admin/deleteSuppliers.php?id=<?php echo $row['id']; ?>" class="btn btn-danger"><i class="fa fa-fw fa-trash-o"></i></a>
