...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $user_uname     = test_input($_POST['username']);
    $user_password  = test_input($_POST['password']);
    $user_type      = test_input($_POST['type']);


    //Checking the values are existing in the database or not
    $query = "INSERT INTO users (username, password, type) VALUES ('$user_uname','$user_password','$user_type')";
                        ...
                        <form  method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="user_username" placeholder="Username" name="username">
                                </div>
                                <div class="form-group">
