...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $branch = test_input($_POST['branches']);


    //Checking the values are existing in the database or not
    $query = "UPDATE branches SET branches='$branch' WHERE id='$users_id'";
    $result = mysqli_query($conn, $query) or die(mysqli_error($conn));
                        ...
                        <form  method="POST"  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>?id=<?php echo $users_id; ?>">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="branch" placeholder="Store Branch" name="branches" value="<?php echo $branch; ?>">
                                </div>
                            </div>
                            <!-- /.box-body -->
