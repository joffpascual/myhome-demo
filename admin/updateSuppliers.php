                        ...
                        <form  method="POST"  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>?id=<?php echo $users_id; ?>">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="supplierName" placeholder="Supplier Name" name="supplier_name" value="<?php echo $supplier_name; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="supplier_contact_person">Contact Person Name:</label>
                                    <input type="text" class="form-control" id="supplierContactPerson" placeholder="Contact Person Name" name="supplier_contact_person" value="<?php echo $supplier_contact_person; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="supplier_email">Email:</label>
                                    <input type="email" class="form-control" id="supplierEmail" placeholder="example@domain.com" name="supplier_email" value="<?php echo $supplier_email; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="supplier_number">Contact Number:</label>
                                    <input type="number" class="form-control" id="supplierNumber" placeholder="Contact Number" name="supplier_number" value="<?php echo $supplier_number; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="supplier_address">Address:</label>
                                    <input type="text" class="form-control" id="supplierAddress" placeholder="Company Address" name="supplier_address" value="<?php echo $supplier_address; ?>">
                                </div>
